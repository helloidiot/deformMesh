...
public class RoundedCube : MonoBehaviour {
	...
	private void CreateVertices(){
		...
		// Cap the top and bottom like a regular plane
		for (int z = 1; z < zSize; z++) {
	...
	// Method for creating a single quad
	...
	// Method to create the top face of the cube
	...
	// Method to create the bottom face of the cube
	...
	private void OnDrawGizmosSelected () {
		...
		for (int i = 0; i < vertices.Length; i++) {
			// Black gizmoes for vertices
			Gizmos.color = Color.black;
			Gizmos.DrawSphere(vertices[i], 0.1f);

			// Yellow gizmos for normals
